...
oral_sex= "[bold white]Voix robotique:[/] Celà fait cinq minutes, pour augmenter en une fois votre complicité d'autant de points il faudra respectivement vous faire un cunnilingus et une fellation pendant trois minutes\n"
...
Humiliation_choice_success = "Vous passez le test des gardes avec succès et vous dirigez vers le dernier sas. Vous rentrez à l'intérieur et sans surprise la voix robotique habituelle vous parle:\n"\
                                ...
                                "3. Vous vous mettez entièrement nu et vous vous masturbez l'un devant l'autre jusqu'à jouir (+100)[/]\n"\
